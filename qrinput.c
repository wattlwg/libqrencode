 ...
 * @return number of bits
 */
int QRinput_estimateBitStreamSize(QRinput *input, int version)//STATIC_IN_RELEASE 
{
	QRinput_List *list;
	int bits = 0;
 ...
 */
int QRinput_lengthOfCode(QRencodeMode mode, int version, int bits)//STATIC_IN_RELEASE 
{
...
int QRinput_mergeBitStream(QRinput *input, BitStream *bstream)//STATIC_IN_RELEASE 
{
	if(input->mqr) {
...
int QRinput_getBitStream(QRinput *input, BitStream *bstream)//STATIC_IN_RELEASE 
{
	int ret;
...
int QRinput_splitEntry(QRinput_List *entry, int bytes)//STATIC_IN_RELEASE 
{
	QRinput_List *e;
	int ret;
