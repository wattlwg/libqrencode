...
int Mask_writeFormatInformation(int width, unsigned char *frame, int mask, QRecLevel level)//STATIC_IN_RELEASE 
{
	unsigned int format;
	unsigned char v;
	int i;
...
int Mask_calcN1N3(int length, int *runLength)//STATIC_IN_RELEASE 
{
	int i;
	int demerit = 0;
	int fact;
...
int Mask_calcN2(int width, unsigned char *frame)//STATIC_IN_RELEASE 
{
	int x, y;
	unsigned char *p;
...
int Mask_calcRunLengthH(int width, unsigned char *frame, int *runLength)//STATIC_IN_RELEASE 
{
	int head;
	int i;
	unsigned char prev;
...
int Mask_calcRunLengthV(int width, unsigned char *frame, int *runLength)//STATIC_IN_RELEASE 
{
	int head;
	int i;
	unsigned char prev;
...
int Mask_evaluateSymbol(int width, unsigned char *frame)//STATIC_IN_RELEASE 
{
	int x, y;
	int demerit = 0;
